...
export const ARTWORKS: ArtPiece[] = [
  // LOVE SECTION
 {
  ...
  // NOVEL SECTION
  {
    id: 'n1',
    section: 'Novel',
    title: 'Mille-Feuille and Fondant au chocolat',
    artist: '베제타',
    subTitle: '',
    story: `
    “저기, 로한, 그…” 
...
`,
  ...
  },
  {
    ...
    subTitle: '',
    story: `
    가을은 정말 좋은 계절이었다. 특히 모리오초에서 맞이하는 가을이라면 더욱이었다. 여름처럼 너무 덥지도 않고, 겨울처럼 너무 춥지도 않고, 봄처럼 날씨가 변덕스럽지도 않은, 적당하면서 시원한 온도는 작업하기 좋은 환경을 만들어 주었다. 보통은 필요한 경우가 아니면 밖에 잘 나가지 않는 키시베 로한이었지만, 가을만큼은 조금 달랐다. 왠지 이 시기만큼은 밖에 나왔을 때 오히려 생각이 잘 풀리는 것 같은 느낌이었기 때문이다.
